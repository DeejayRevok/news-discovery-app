...
def load() -> None:
    rabbitmq_host = os.environ.get("NEWS_DISCOVERY_RABBIT__HOST")
    rabbitmq_port = os.environ.get("NEWS_DISCOVERY_RABBIT__PORT")
    rabbitmq_user = os.environ.get("NEWS_DISCOVERY_RABBIT__USER")
    rabbitmq_password = os.environ.get("NEWS_DISCOVERY_RABBIT__PASSWORD")
